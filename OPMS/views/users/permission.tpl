              ...
              <section id="unseen">
                <form id="permission-form">
                  <ul class="list-unstyled">
                    ...
                    <li data-pmodel="用户管理-user-user||#" class="border">
                      <h4>用户管理</h4>
                      <ul class="list-unstyled">
                        <li>
                          <div class="form-group" data-cmodel="员工-user||user-manage"> 用户：
                            <label class="checkbox-inline">
                        ...
                        <li>
                          <div class="form-group" data-cmodel="部门-user||department-manage"> 组：
                            <label class="checkbox-inline">
